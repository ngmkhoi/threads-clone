...
export default function RepostButton({ count }) {
                ...
                <DialogContent className="sm:max-w-lg min-h-[375px] bg-dialog-background !rounded-2xl">
                    ...
                    <DialogHeader>
                        <DialogTitle className="text-center text-3xl font-bold">
                            {t('DialogMessage:dialogMessages.Repost.title')}
                        </DialogTitle>
                        <DialogDescription className="text-center text-sm text-muted-foreground mt-2">
                            {t('DialogMessage:dialogMessages.Repost.description')}
                        </DialogDescription>
                    </DialogHeader>
